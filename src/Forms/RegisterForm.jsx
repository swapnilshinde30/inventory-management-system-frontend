                    ...
                    <div>
                      ...
                      <div className="flex -mx-3">
                        <div className="w-full px-3 mb-1 mt-8">
                          <button className="block w-full max-w-xs mx-auto gradient-form bg-gradient-to-r from-emerald-400 to-teal-600 hover:bg-emerald-700 focus:bg-emerald-700 text-white rounded-lg px-3 py-3 font-semibold">
                            REGISTER NOW
                          </button>
                        </div>
                      </div>
