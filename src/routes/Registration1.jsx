...
const Register1=()=>{
    ...
    return(
        <div className="flex bg-teal-500 justify-center text-center sm:items-center sm:p-0">
        <div className="transform w-[800px] h-[560px] overflow-hidden rounded-lg bg-white text-left shadow-xl transition-all sm:my-8">
                  ...
                  <div className="flex -mx-3">
                    <div className="w-1/2 px-3">
                      ...
                      <div className="flex">
                        ...
                        <input
                          type="text"
                          className="w-full -ml-10 pl-10 pr-3 py-1 rounded-lg border-2 border-gray-200 outline-none focus:border-emerald-500"
