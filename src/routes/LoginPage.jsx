      ...
      <div className="flex items-center justify-center ">
        ...
        >
          ...
          <div className="relative">
            <div class="absolute top-[325px] left-[400px]">
                              ...
                              <div class="transform overflow-hidden rounded-lg bg-white text-left shadow-xl transition-all sm:my-8">
                                <div class="bg-gray-100 text-gray-500">
                                  <div class="md:flex w-full">
                                    <div class="hidden md:block w-1/2 gradient-form bg-gradient-to-r from-emerald-400 to-teal-600 py-10 px-10">
                                      <svg
                                    ...
                                    <div class="w-full md:w-1/2 py-6 px-5 md:px-10">
                                      ...
                                      <div>
                                        <div class="flex -mx-3">
                                          <div class="w-1/2 px-3 mb-2">
                                            ...
                                            <div class="flex">
                                              ...
                                              <input
                                                type="text"
                                                class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-emerald-500"
                                                placeholder="Sachin"
                                              />
                                            </div>
                                          </div>
                                        ...
                                        <select
                                          id="role"
                                          class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-emerald-500 focus:border-emerald-500 block w-full p-2.5 dark:bg-emerald-700 dark:border-emerald-600 dark:placeholder-emerald-400 dark:text-white dark:focus:ring-emerald-500 dark:focus:border-emerald-500"
                                        >
                                        ...
                                        <div class="flex -mx-3">
                                          <div class="w-full px-3 mb-1 mt-8">
                                            <button class="block w-full max-w-xs mx-auto gradient-form bg-gradient-to-r from-emerald-400 to-teal-600 hover:bg-emerald-700 focus:bg-emerald-700 text-white rounded-lg px-3 py-3 font-semibold">
                                              REGISTER NOW
                                            </button>
                                          </div>
                                        </div>
